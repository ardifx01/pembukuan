    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Isi data supplier di bawah ini</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden">
                ...
                <form method="POST" action="{{ route('supplier.store') }}" class="p-8">
                    @csrf
                    ...
                    <div class="mb-6 pb-4 border-b border-gray-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-800">Form Tambah Supplier</h3>
                                <p class="text-sm text-gray-500">Lengkapi data supplier di bawah ini</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="3" 
                                      ...
                                      placeholder="Jl. Raya ...">{{ old('address') }}</textarea>
                        </div>
